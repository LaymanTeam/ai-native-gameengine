...
/**
 * Minimal, dependency-free Markdown renderer for the subset the engine/LLM emits in chat replies
 * and artifacts (headings, blockquote, ordered + unordered lists incl. nesting, **bold**, *italic*,
